            ...
            {actualites
              .filter((actualite) => {
                return (
                  ...
                  actualite.text.toUpperCase().includes(search.toUpperCase())
                )
              })
              .map((actualite) => {
                return (
                  ...
                  >
                    ...
                    <TableCell align="center">
                      <img
                        height={'50px'}
                        src={'http://127.0.0.1:5000/images/' + actualite.image}
                        alt=""
                      />
                    </TableCell>
                    ...
                    <TableCell align="center">
                      {dayjs(actualite.createdAt).format('DD-MM-YYYY -  HH:mm')}
                    </TableCell>
                    <TableCell align="center">
                      {actualite.deletedAt &&
                    ...
                    >
                      {actualite.deletedAt !== null ? (
                        <Button
                          onClick={() => deleteActualite(actualite._id)}
                          color="success"
                          variant="contained"
